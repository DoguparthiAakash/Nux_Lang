...
echo %CYAN%    ║               ░░░░ ░█░░░   ▒█ ░     ██║ ╚███║╚██████╔╝██╔╝ ██╗         ║%NC%
echo %CYAN%    ║                    ▒█░▒▒   ▒█░░     ╚═╝  ╚══╝ ╚═════╝ ╚═╝  ╚═╝         ║%NC%
echo %CYAN%    ║             ░░▓▓▓▓▓█▓░▓▓   ▒█░▒░     %WHITE%Programming Language%CYAN%         ║%NC%
echo %CYAN%    ║            ▒▒▒▓▓▓▓▓▒▒██░    ▒░░▒           %YELLOW%v%VERSION%%CYAN%                 ║%NC%
echo %CYAN%    ║                                      %GREEN%Windows Installer%CYAN%              ║%NC%
echo %CYAN%    ╚═══════════════════════════════════════════════════════════════════╝%NC%
echo.
goto :eof
...
echo %GREEN%    ║               ░░░░ ░█░░░   ▒█ ░     ██║ ╚███║╚██████╔╝██╔╝ ██╗         ║%NC%
echo %GREEN%    ║                    ▒█░▒▒   ▒█░░     ╚═╝  ╚══╝ ╚═════╝ ╚═╝  ╚═╝         ║%NC%
echo %GREEN%    ║             ░░▓▓▓▓▓█▓░▓▓   ▒█░▒░     %WHITE%Programming Language%GREEN%         ║%NC%
echo %GREEN%    ║            ▒▒▒▓▓▓▓▓▒▒██░    ▒░░▒           %YELLOW%v%VERSION%%GREEN%                 ║%NC%
echo %GREEN%    ║                                      %GREEN%Windows Installer%GREEN%              ║%NC%
echo %GREEN%    ╠═══════════════════════════════════════════════════════════════════╣%NC%
echo %GREEN%    ║                                                                   ║%NC%
