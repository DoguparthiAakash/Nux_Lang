...
pub fn compile(source: &str) -> Result<Vec<u8>, String> {
    ...
    while let Some(line) = lines.next() {
        ...
        match mnemonic.as_str() {
            ...
            "MEM_ALLOC" => ops.push(0x82),
            "MEM_FREE" => ops.push(0x83),
            "MEM_READ8" => ops.push(0x84),
            "MEM_WRITE8" => ops.push(0x85),
            "MEM_READ64" => ops.push(0x86),
            "MEM_WRITE64" => ops.push(0x87),
            "MEM_COPY" => ops.push(0x88),
            "MEM_SET" => ops.push(0x89),
            "MEM_SIZE" => ops.push(0x8A),
            "OP_SYS_PLATFORM" => ops.push(0x8B),
